...
var letterHeight = getComputedStyle(element).getPropertyValue('--letter-height');
...
function randomCss() {
    ...
    for (i = 0; i < fragmentsEn.length; i++) {
        ...
        //tl2.to(".scaleDownEn", { duration: 5, ease: "smooth", height: 280});
    ...
    for (i = 0; i < fragmentsDe.length; i++) {
        ...
        //tl2.to(".scaleDownDe", { duration: 2.5, ease: "smooth", height: 280, delay: 1 });
    }
}
